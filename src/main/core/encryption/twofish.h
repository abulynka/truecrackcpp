...
#ifndef TRUECRACKCPP_SRC_MAIN_CORE_CRYPTO_TWOFISH_H_
#define TRUECRACKCPP_SRC_MAIN_CORE_CRYPTO_TWOFISH_H_
...
class Twofish: public Encryption {
 public:
...
#endif //TRUECRACKCPP_SRC_MAIN_CORE_CRYPTO_TWOFISH_H_
